...
to optimize them away. But in some cases there are logicaÃl and mathematical ways of accomplishing the same
...
If both registers are zero, if Carry is also 0, all will remain 0. But if Carry is 1, register2 will underfÃlow
